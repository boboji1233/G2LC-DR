...
2. A decision context consists of ontology feasibility plus deterministic unary total
   derivations. Complete, partial, finite, SMT, repair, and verifier paths use it.
...
6. Generated semantic tests vary 2–6 typed predicates, 1–3 guidelines, feasibility,
   unary derivation, prerequisites, and Decimal objectives and compare all solver paths.
